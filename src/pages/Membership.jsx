      ...
      <div className="container mx-auto px-4">
        ...
        <section className="membership-benefits py-10">
          ...
          <p className="text-center mt-6 animate__animated animate__fadeIn animate__delay-2s">
            To join ZIP, please{' '}
            <a href="/register" className="btn btn-primary text-white bg-indigo-600 py-2 px-4 rounded-lg shadow-md hover:bg-indigo-700 transform hover:scale-105 transition duration-300">
              Register Now
            </a>
          </p>
        </section>
